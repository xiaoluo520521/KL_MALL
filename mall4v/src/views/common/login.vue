...
<!--      <el-image src="https://th.bing.com/th/id/OIP.qJKqtIufb-QZ00P_ZCophAHaH6?w=162&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" style="width: 10px;margin-left: 5px"></el-image>-->
    <div class="bottom">Copyright © 2022 厦门坤凌系统工程股份有限公司<img src="~@/assets/img/备案.jpg" alt="" style="width: 15px;margin-left: 10px"> 备案号：<a href="https://beian.miit.gov.cn/" rel="nofollow" target="_blank" title="链接关键词">湘ICP备2023017804号</a></div>
    </div>
    <Verify
        ref="verify"
